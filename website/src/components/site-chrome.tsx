...
export const repositoryUrl = 'https://github.com/Melvynx/code-os'

function Brand() {
  return (
    <Link to="/" className="brand" aria-label="Code OS home">
    ...
    <header className="site-header">
      <div className="header-inner">
        ...
        <nav className={open ? 'main-nav is-open' : 'main-nav'} aria-label="Primary navigation">
          ...
          <a href="/app/" onClick={() => setOpen(false)}>Dashboard</a>
        </nav>
        <div className="header-actions">
          ...
          <a className="button button-primary button-small" href="/app/">Open dashboard</a>
