...
export function StackEnvWindow() {
  return (
    <div className="product-window" aria-label="StackEnv command center preview">
      <div className="window-bar">
        <span className="window-dot" /><span className="window-dot" /><span className="window-dot" />
        <span className="window-address">stackenv.melvynx.dev</span>
      </div>
      <div className="window-body">
        <aside className="demo-sidebar">
          <div className="demo-brand"><span>S</span><b>StackEnv</b></div>
