...
func (server HTTPServer) Handler() (http.Handler, error) {
	...
	protected.HandleFunc("GET /api/resources", server.resources)
	...
	protected.HandleFunc("GET /api/status", server.status)
	protected.HandleFunc("GET /api/skills-sync", server.skillsSyncStatus)
	protected.HandleFunc("POST /api/skills-sync", server.runSkillsSync)
