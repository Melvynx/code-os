...
export function ApplicationTable({ applications, compact = false }: Readonly<{ applications: Application[]; compact?: boolean }>) {
  return (
    <Table>
      ...
      <TableHeader>
        <TableRow>
          ...
          {!compact ? <TableHead><span className="sr-only">Open</span></TableHead> : null}
        </TableRow>
      </TableHeader>
      <TableBody>
